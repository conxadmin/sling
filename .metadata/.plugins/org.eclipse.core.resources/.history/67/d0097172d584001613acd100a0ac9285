...
import org.apache.sling.auth.trusted.token.api.resource.lite.Repository;
import org.apache.sling.auth.trusted.token.api.resource.lite.Session;
import org.apache.sling.auth.trusted.token.api.resource.lite.StorageClientException;
import org.apache.sling.auth.trusted.token.api.resource.lite.StorageClientUtils;
import org.apache.sling.auth.trusted.token.api.resource.lite.accesscontrol.AccessDeniedException;
import org.apache.sling.auth.trusted.token.api.resource.lite.accesscontrol.AclModification;
import org.apache.sling.auth.trusted.token.api.resource.lite.accesscontrol.AclModification.Operation;
import org.apache.sling.auth.trusted.token.api.resource.lite.accesscontrol.Permissions;
import org.apache.sling.auth.trusted.token.api.resource.lite.accesscontrol.Security;
import org.apache.sling.auth.trusted.token.api.resource.lite.authorizable.Group;
import org.apache.sling.auth.trusted.token.api.resource.lite.authorizable.User;
import org.apache.sling.auth.trusted.token.api.resource.lite.content.Content;
import org.apache.sling.auth.trusted.token.api.resource.CopyCleaner;
import org.apache.sling.auth.trusted.token.api.resource.MoveCleaner;
...
public abstract class AbstractBasicLtiCleaner implements CopyCleaner, MoveCleaner {
  ...
  /**
   * {@inheritDoc}
   * @see org.apache.sling.auth.trusted.token.api.resource.CopyCleaner#clean(java.lang.String, java.lang.String, org.apache.sling.auth.trusted.token.api.resource.lite.Session)
   */
  @Override
