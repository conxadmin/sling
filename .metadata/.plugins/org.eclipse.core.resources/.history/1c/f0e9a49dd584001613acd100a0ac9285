...
import org.apache.sling.auth.trusted.token.api.lite.StorageClientUtils;
import org.apache.sling.auth.trusted.token.api.lite.accesscontrol.AccessDeniedException;
import org.apache.sling.auth.trusted.token.api.lite.content.Content;
import org.apache.sling.auth.trusted.token.api.lite.content.ContentManager;
