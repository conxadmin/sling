...
/**
 * <p>
 * NOTE: CLASS COPIED FROM SLING UNTIL WE MOVE TO USING THE 2.1.0 RESOURCE BUNDLES
 * </p>
 *
 * The <code>AbstractResource</code> is an abstract implementation of the {@link Resource}
 * interface.
 * <p>
