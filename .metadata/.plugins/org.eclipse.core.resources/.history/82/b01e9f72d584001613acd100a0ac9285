...
import org.apache.sling.auth.trusted.token.api.resource.DateParser;
import org.apache.sling.auth.trusted.token.api.resource.lite.AbstractSparseCreateOperation;
import org.apache.sling.auth.trusted.token.api.resource.lite.SparseContentResource;
import org.apache.sling.auth.trusted.token.api.resource.lite.SparseNonExistingResource;
import org.apache.sling.auth.trusted.token.api.resource.lite.SparsePropertyValueHandler;
import org.apache.sling.auth.trusted.token.api.resource.lite.SparseRequestProperty;
