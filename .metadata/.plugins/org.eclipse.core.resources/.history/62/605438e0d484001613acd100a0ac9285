 ...
 */
public interface SparsePostOperation {

    /**
     * The name of the Sling POST operation service (value is
     * "org.apache.sling.servlets.post.SlingPostOperation").
     */
    public static final String SERVICE_NAME = SparsePostOperation.class.getName();
     ...
     */
    void run(SlingHttpServletRequest request, HtmlResponse response, SparsePostProcessor[] processors);
}
