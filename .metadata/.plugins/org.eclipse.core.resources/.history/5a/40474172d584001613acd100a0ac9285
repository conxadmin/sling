 ...
 */
package org.apache.sling.auth.trusted.token.internal.validator;
...
import org.apache.sling.auth.trusted.token.api.RequestTrustValidator;
import org.apache.sling.auth.trusted.token.api.RequestTrustValidatorService;
...
public class RequestTrustValidatorServiceImpl implements RequestTrustValidatorService {
  ...
  /**
   * {@inheritDoc}
   * @see org.apache.sling.auth.trusted.token.api.RequestTrustValidatorService#getValidator(java.lang.String)
   */
