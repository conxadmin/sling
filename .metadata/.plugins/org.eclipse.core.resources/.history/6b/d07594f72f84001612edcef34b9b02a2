...
import org.apache.sling.auth.sso.cas.impl.FormAuthenticationHandler;
...
final class FormLoginModule extends AbstractLoginModule {
    ...
    /**
     * The {@link org.apache.sling.auth.sso.cas.impl.FormAuthenticationHandler} used to validate the credentials
     * and its contents.
     */
