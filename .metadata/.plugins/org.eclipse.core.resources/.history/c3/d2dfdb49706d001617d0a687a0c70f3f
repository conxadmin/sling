...
public class JobConsumerManager {
    ...
    public static final String PROPERTY_WHITELIST = "job.consumermanager.whitelist";

    public static final String PROPERTY_BLACKLIST = "job.consumermanager.blacklist";
