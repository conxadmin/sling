...
public class ContentLoaderService implements SynchronousBundleListener, BundleHelper {
     ...
     */
    private volatile ContentReaderWhiteboard contentReaderWhiteboard;
    ...
    protected volatile SlingSettingsService settingsService;
    
    protected volatile BundleContext componentContext;
    ...
    protected void activate() {
        ...
        componentContext.addBundleListener(this);
        ...
        try {
            ...
            int ignored = 0;
            Bundle[] bundles = componentContext.getBundles();
    ...
    protected void deactivate() {
        componentContext.removeBundleListener(this);
