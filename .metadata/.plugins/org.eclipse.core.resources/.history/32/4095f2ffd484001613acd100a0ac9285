...
import org.apache.sling.auth.trusted.token.api.user.AuthorizableEvent.Operation;
import org.apache.sling.auth.trusted.token.api.user.GroupModification;
import org.apache.sling.auth.trusted.token.api.user.UserModification;
