 ...
 * <h4>Notes</h4>
 */
public class CreateGroupServlet extends AbstractGroupPostServlet implements CreateGroup, ManagedService {
    private static final long serialVersionUID = -1084915263933901466L;

    private volatile JcrResourceResolverFactory resourceResolverFactory;
