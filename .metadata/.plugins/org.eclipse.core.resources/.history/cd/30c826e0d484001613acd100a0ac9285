...
public class SparseContentResource extends AbstractResource {
  ...
  /**
   * {@inheritDoc}
   * @see org.apache.sling.auth.trusted.token.api.resource.lite.AbstractResource#adaptTo(java.lang.Class)
   */
  ...
  /**
   * @see org.apache.sling.auth.trusted.token.api.resource.lite.AbstractResource#listChildren()
   */
  @Override
