 ...
 */
package org.apache.sling.auth.trusted.token.internal.http.usercontent;
...
import org.apache.sling.auth.trusted.token.api.auth.trusted.TokenTrustValidator;
import org.apache.sling.auth.trusted.token.api.auth.trusted.TrustedTokenService;
...
public class UserContentAuthenticationHandler implements AuthenticationHandler, TokenTrustValidator {
   ...
   * {@inheritDoc}
   * @see org.apache.sling.auth.trusted.token.api.auth.trusted.TokenTrustValidator#isTrusted(javax.servlet.http.HttpServletRequest)
   */
