...
public class FormAuthenticationHandler extends DefaultAuthenticationFeedbackHandler implements AuthenticationHandler, ManagedService {
     ...
     */
    static final String PAR_LOGIN_FORM = "form.login.form";
    ...
    static final String PAR_AUTH_STORAGE = "form.auth.storage";
     ...
     * @see #PAR_AUTH_NAME
     */
    static final String DEFAULT_AUTH_NAME = "sling.formauth";

    /**
     * The name of the configuration parameter providing the Cookie or session
     * attribute name.
     */
    static final String PAR_AUTH_NAME = "form.auth.name";
     ...
     */
    static final String PAR_CREDENTIALS_ATTRIBUTE_NAME = "form.credentials.name";
     ...
     */
    static final String PAR_AUTH_TIMEOUT = "form.auth.timeout";
     ...
     */
    static final String PAR_TOKEN_FILE = "form.token.file";

    static final boolean DEFAULT_TOKEN_FAST_SEED = false;
     ...
     * device for seeding.
     */
    static final String PAR_TOKEN_FAST_SEED = "form.token.fastseed";
     ...
     */
    static final boolean DEFAULT_INCLUDE_FORM = false;

    /**
     * Whether to redirect to the login form or simple do an include.
     */
    static final String PAR_INCLUDE_FORM = "form.use.include";
     ...
     */
    static final boolean DEFAULT_LOGIN_AFTER_EXPIRE = false;

    /**
     * Whether to present a login form when a users cookie expires, the default
     * is not to present the form.
     */
    static final String PAR_LOGIN_AFTER_EXPIRE = "form.onexpire.login";

    /**
     * The default domain on which to see the auth cookie (if cookie storage is used)
     */
    static final String PAR_DEFAULT_COOKIE_DOMAIN = "form.default.cookie.domain";
