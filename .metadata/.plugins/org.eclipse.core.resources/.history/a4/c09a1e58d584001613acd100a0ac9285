...
import org.apache.sling.auth.trusted.token.api.http.usercontent.ServerProtectionValidator;
import org.apache.sling.auth.trusted.token.api.http.usercontent.ServerProtectionVeto;
