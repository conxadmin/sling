...
package org.apache.sling.auth.trusted.token.internal.resource.lite.servlet.post;
...
import org.apache.sling.auth.trusted.token.api.resource.lite.accesscontrol.Permission;
