...
public interface BundleAuthenticationRequirement {
     ...
     */
    void setRequirements(Map<String, Boolean> requirements);
     ...
     * @throws NullPointerException If requirements is {@code null}
     */
    void appendRequirements(Map<String, Boolean> requirements);
     ...
     * @throws NullPointerException If requirements is {@code null}
     */
    void removeRequirements(Map<String, Boolean> requirements);
