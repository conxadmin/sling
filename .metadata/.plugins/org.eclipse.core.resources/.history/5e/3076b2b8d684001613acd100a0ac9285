...
import org.apache.sling.auth.trusted.token.api.http.cache.CacheConfig;
import org.apache.sling.auth.trusted.token.api.http.cache.StaticContentResponseCache;
