...
public class BundleAuthenticationRequirementImpl implements BundleAuthenticationRequirement {
    ...
    @Override
    public void setRequirements(final Map<String, Boolean> requirements) {
    ...
    @Override
    public void appendRequirements(final Map<String, Boolean> requirements) {
        final Collection<AuthenticationRequirementHolder> reqHolders = createHolders(requirements);
        register(reqHolders);
    }

    @Override
    public void removeRequirements(final Map<String, Boolean> requirements) {
        final Collection<AuthenticationRequirementHolder> reqHolders = createHolders(requirements);
    ...
    private Set<AuthenticationRequirementHolder> createHolders(Map<String,Boolean> requirements) {
    ...
    private void register(final Collection<AuthenticationRequirementHolder> authReqs) {
