...
public class ServicesListener implements StartupListener {
     ...
     * Start listeners
     */
    public ServicesListener(final BundleContext bundleContext, final DependencyManager dm) {
    	this.dm = dm;
    ...
    private void registerProvider2(final Object authSupport, final Object authenticator) {
		...
		Component component = dm.createComponent()
				...
				.setImplementation(new SlingWebConsoleSecurityProvider2(authSupport, authenticator))
				//.add(dm.createConfigurationDependency().setPid(SlingWebConsoleSecurityProvider.class.getName()))
	            ;
		this.provider2Reg = component.getInstance();
		dm.add(component);
