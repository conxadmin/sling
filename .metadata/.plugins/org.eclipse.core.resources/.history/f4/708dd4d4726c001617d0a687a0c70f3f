...
public class SlingMainServlet extends GenericServlet {
    ...
    public static final String PROP_MAX_RECORD_REQUESTS = "sling.max.record.requests";

    public static final String PROP_TRACK_PATTERNS_REQUESTS = "sling.store.pattern.requests";

    public static final String PROP_DEFAULT_PARAMETER_ENCODING = "sling.default.parameter.encoding";
