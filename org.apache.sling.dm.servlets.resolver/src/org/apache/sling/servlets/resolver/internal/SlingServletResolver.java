...
public class SlingServletResolver
    ...
    private Map<String, Object> createAuthenticationInfo(final Dictionary<String, ?> props) {
    ...
    protected void activate() throws LoginException {
        ...
        synchronized (this.pendingServlets) {
            ...
            this.sharedScriptResolver =
                    resourceResolverFactory.getAdministrativeResourceResolver(this.createAuthenticationInfo(this.properties));
        ...
        this.eventHandlerReg = context.registerService(EventHandler.class.getName(), this,
                properties);
        ...
        if (this.cacheSize > 0) {
            try {
                ...
                mbeanRegistration = context.registerService(SlingServletResolverCacheMBean.class.getName(), mbean, mbeanProps);
            } catch (Throwable t) {
