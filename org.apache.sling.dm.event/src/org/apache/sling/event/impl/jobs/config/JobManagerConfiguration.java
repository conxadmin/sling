 ...
 *
 */
public class JobManagerConfiguration implements ManagedService {
    ...
    private volatile EnvironmentComponent environment;

    private volatile ResourceResolverFactory resourceResolverFactory;

    private volatile QueueConfigurationManager queueConfigManager;
