 ...
 */
public class ScriptCacheImpl implements EventHandler, ScriptCache, ManagedService {
    ...
    private volatile ResourceResolverFactory rrf = null;

    private volatile ThreadPoolManager threadPoolManager = null;
