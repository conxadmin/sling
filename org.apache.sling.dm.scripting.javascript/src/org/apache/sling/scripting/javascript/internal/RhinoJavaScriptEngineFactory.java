 ...
 */
public class RhinoJavaScriptEngineFactory extends AbstractScriptEngineFactory implements ScopeProvider, ManagedService {
    ...
    private volatile ScriptCache scriptCache = null;
