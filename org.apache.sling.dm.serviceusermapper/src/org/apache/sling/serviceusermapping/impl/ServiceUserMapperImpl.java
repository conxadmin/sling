...
public class ServiceUserMapperImpl implements ServiceUserMapper, ManagedService {
    ...
    synchronized void configure() {
        ...
        this.defaultUser = PropertiesUtil.toString(this.properties.get(PROP_DEFAULT_USER), PROP_DEFAULT_USER_DEFAULT);
