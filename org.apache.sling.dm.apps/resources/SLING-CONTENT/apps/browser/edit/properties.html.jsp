...
<body>
	...
	<div style="display:none">
		<form id="propertyFormTmpl"  method="post" action="/${slingRequest.resourceResolver.tenantID}/${resource.path}" enctype="multipart/form-data">
			<div class="clear"></div>
	...
	<form method="post" id="mixinForm" action="/${slingRequest.resourceResolver.tenantID}/${resource.path}" enctype="multipart/form-data">
	...
	<form method="post" action="/${slingRequest.resourceResolver.tenantID}/${resource.path}" enctype="multipart/form-data">
	...
	<script>
		var resourcePath = "/${slingRequest.resourceResolver.tenantID}/${resource.path}";
