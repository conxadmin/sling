...
public class CacheImpl<V> implements Cache<V> {
   ...
   * {@inheritDoc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#clear()
   */
  public void clear() {
    cache.removeAll();
  }
   ...
   * {@inheritDoc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#containsKey(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#get(java.lang.String)
   */
   ...
   * {@inherit-doc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#put(java.lang.String, java.lang.Object)
   */
  @SuppressWarnings("unchecked")
   ...
   * {@inherit-doc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#remove(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#removeChildren(java.lang.String)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.apache.sling.auth.trusted.token.api.memory.Cache#list()
   */
  @SuppressWarnings("unchecked")
  public List<V> list() {
