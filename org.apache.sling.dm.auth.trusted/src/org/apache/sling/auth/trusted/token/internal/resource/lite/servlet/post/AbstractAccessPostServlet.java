...
import org.apache.sling.auth.trusted.token.api.resource.JSONResponse;
...
public abstract class AbstractAccessPostServlet extends SlingAllMethodsServlet {
   ...
   * 
   * @see
   * org.apache.sling.api.servlets.SlingAllMethodsServlet#doPost(org.apache.sling.api.
  ...
  abstract protected void handleOperation(SlingHttpServletRequest request,
      ...
      throws StorageClientException, ServletException, AccessDeniedException;
