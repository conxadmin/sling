 ...
 * </code>
 */
public class CreateUserServlet extends AbstractUserPostServlet implements CreateUser, ManagedService {
    ...
    protected void activate(Component component) {
        ...
        this.userAdminGroupName = OsgiUtil.toString(super.properties.get(PAR_USER_ADMIN_GROUP_NAME),
