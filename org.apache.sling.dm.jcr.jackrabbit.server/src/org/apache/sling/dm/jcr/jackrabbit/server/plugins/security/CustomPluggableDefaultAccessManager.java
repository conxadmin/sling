 ...
 */
public class CustomPluggableDefaultAccessManager extends DefaultAccessManager {

    private AccessManagerPlugin accessManagerPlugin;
    private NamePathResolver namePathResolver;
    private static final Logger log = LoggerFactory.getLogger(CustomPluggableDefaultAccessManager.class);
    protected AccessManagerPluginFactory accessManagerFactory;
    protected CustomAccessManagerFactoryTracker accessManagerFactoryTracker;
    ...
    public CustomPluggableDefaultAccessManager() {
    }
    ...
    public void init(AMContext context, AccessControlProvider acProvider, WorkspaceAccessManager wspAccessMgr) throws AccessDeniedException, Exception {
        try {
        	accessManagerFactoryTracker = ensureSlingServerRepositoryManager().getAccessManagerFactoryTracker();
        }
