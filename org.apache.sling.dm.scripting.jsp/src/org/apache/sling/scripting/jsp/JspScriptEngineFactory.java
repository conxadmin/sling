...
public class JspScriptEngineFactory
    ...
    implements EventHandler, Servlet, ManagedService {
    ...
    protected void activate() {
        ...
        try {
            ...
            this.tldLocationsCache = new SlingTldLocationsCache(componentContext);
            ...
            options = new JspServletOptions(slingServletContext, ioProvider,
                this.properties, tldLocationsCache);
    ...
    protected void bindSlingServletContext(
