...
public class JcrInstaller implements UpdateHandler, ManagedService {
     ...
     */
    private volatile SlingSettingsService settings;

    /**
     * The OsgiInstaller installs resources in the OSGi framework.
     */
    private volatile OsgiInstaller installer;
    ...
    protected void activate() {
        ...
        this.managedServiceRef = this.componentContext.registerService(ManagedService.class.getName(),
                this,
                props);
    }
