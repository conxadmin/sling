...
public class InstallerConfig {
    ...
    private Object getPropertyValue(final Logger logger, final BundleContext ctx, final Dictionary<?, ?> oldConfig, final String name) {
        Object result = null;
        if ( oldConfig != null ) {
            ...
            if ( result != null ) {
                logger.warn("Using configuration value from obsolete configuration with PID {} for property {}." +
                            ...
                            new Object[] {JcrInstaller.OLD_PID, name, ctx.getProperty(Constants.SERVICE_PID)});
            }
        }
        if ( result == null ) {
